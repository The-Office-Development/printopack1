...
var MODELS={
 ...
 team:{label:"Our Team",singular:"Member",icon:"team",group:"Content",
  ...
  fields:[{name:"photo",type:"image",label:"Photo",frame:"1/1",rec:"600 × 600px (square, JPG)"},{name:"mono",type:"text",label:"Monogram (initials, shown until a photo is added)",half:true},{name:"name",type:"text",label:"Name (English)",half:true},{name:"role",type:"text",label:"Role (English)",half:true},{name:"nameAr",type:"text",label:"Name",ar:"Arabic",rtl:true,half:true},{name:"roleAr",type:"text",label:"Role",ar:"Arabic",rtl:true,half:true},{name:"email",type:"text",label:"Email",half:true},{name:"experience",type:"number",label:"Years of experience",half:true},{name:"bio",type:"textarea",label:"Short note (English)",rec:"Shown in the profile that opens from the photo or Read more on the Our Team page. Leave a blank line between paragraphs."},{name:"bioAr",type:"textarea",label:"Short note",ar:"Arabic",rtl:true}]},
